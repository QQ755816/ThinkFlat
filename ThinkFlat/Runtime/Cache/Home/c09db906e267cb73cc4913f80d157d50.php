    ...
    <div class="container-fluid">
        <div class="page-header">
            ...
            <div class="pull-right">
                <ul class="minitiles">
                    <li class="grey"> <a href="javascript:;"><i class="icon-cogs"></i></a> </li>
                    <li class="lightgrey"> <a href="javascript:;"><i class="icon-globe"></i></a> </li>
                </ul>
                <ul class="stats">
                        ...
                        <table class="table table-bordered table-striped table-force-topborder" style="clear: both">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="50%"><a href="javascript:;" data-type="text" data-pk="1" data-original-title="Enter username" class="editable editable-click">superuser</a></td>
                                    <td width="35%" class="hidden-480"><span class="muted">Simple text field</span></td>
                                </tr>
                                <tr>
                                    <td>First name</td>
                                    <td><a href="javascript:;" data-type="text" data-pk="1" data-placement="right" data-placeholder="Required" data-original-title="Enter your firstname" class="editable editable-click editable-empty">Empty</a></td>
                                    <td class="hidden-480"><span class="muted">Required text field, originally empty</span></td>
                                </tr>
                                <tr>
                                    <td>Sex</td>
                                    <td><a href="javascript:;" data-type="select" data-pk="1" data-value="" data-original-title="Select sex" class="editable editable-click" style="color: gray;">not selected</a></td>
                                    <td class="hidden-480"><span class="muted">Select, loaded from js array. Custom display</span></td>
                                </tr>
                                <tr>
                                    <td>Group</td>
                                    <td><a href="javascript:;" data-type="select" data-pk="1" data-value="5" data-original-title="Select group" class="editable editable-click">Admin</a></td>
                                    <td class="hidden-480"><span class="muted">Select, loaded from server. <strong>No buttons</strong> mode</span></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td><a href="javascript:;" data-type="select" data-pk="1" data-value="0" data-original-title="Select status" class="editable editable-click">Active</a></td>
                                    <td class="hidden-480"><span class="muted">Error when loading list items</span></td>
                                </tr>
                                <tr>
                                    <td>Plan vacation?</td>
                                    <td><a href="javascript:;" data-type="date" data-viewformat="YYYY-MM-DD" data-pk="1" data-placement="right" data-original-title="When you want vacation to start?" class="editable editable-click">2013-02-25</a></td>
                                    <td class="hidden-480"><span class="muted">Datepicker</span></td>
                                </tr>
                                <tr>
                                    <td>Date of birth</td>
                                    <td><a href="javascript:;" data-type="combodate" data-value="1984-05-15" data-format="YYYY-MM-DD" data-viewformat="YYYY-MM-DD" data-template="YYYY-MM-DD" data-pk="1" data-original-title="Select Date of birth" class="editable editable-click">1984-05-15</a></td>
                                    <td class="hidden-480"><span class="muted">Date field (combodate)</span></td>
                                </tr>
                                <tr>
                                    <td>Setup event</td>
                                    <td><a href="javascript:;" data-type="combodate" data-template="YYYY-MM-DD HH:mm" data-format="YYYY-MM-DD HH:mm" data-viewformat="YYYY-MM-DD HH:mm" data-pk="1" data-original-title="Setup event date and time" class="editable editable-click editable-empty">Empty</a></td>
                                    <td class="hidden-480"><span class="muted">Datetime field (combodate)</span></td>
                                </tr>
                                <tr>
                                    <td>Comments</td>
                                    <td><a href="javascript:;" data-type="textarea" data-pk="1" data-placeholder="Your comments here..." data-original-title="Enter comments" class="editable editable-click">awesome<br>
                                            user!</a></td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="javascript:;" data-type="address" data-pk="1" dataa-original-title="Please fill address" class="editable editable-click"></a></td>
